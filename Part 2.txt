...
//fucntion for drawing square
void draw_square(int astr_x, int astr_y) {
	//data point x,y
...
void Display()
{
	...
	//draw square at data point
	draw_square(120, new_monday_earning);
	draw_square(190, new_tuesday_earning);
	draw_square(260, new_wednesday_earning);
	draw_square(330, new_thursday_earning);
	draw_square(400, new_friday_earning);
	draw_square(470, new_saturday_earning);


	//increase line width to two
	glLineWidth(2.0); 
