...
void draw_circle(int astr_x, int astr_y) {
	//data point x,y
...
//Draw cream background for color chart
void color_chart() {
	glColor3f(0.996, 0.988, 0.812);
...
void Display()
{
	...
	//draw circle at datapoint
	draw_circle(120, new_monday_earning);
	draw_circle(190, new_tuesday_earning);
	draw_circle(260, new_wednesday_earning);
	draw_circle(330, new_thursday_earning);
	draw_circle(400, new_friday_earning);
	draw_circle(470, new_saturday_earning);
